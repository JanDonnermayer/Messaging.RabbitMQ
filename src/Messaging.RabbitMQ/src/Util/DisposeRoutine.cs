...
namespace Messaging.RabbitMQ
{
    ...
    /// </summary>
    internal sealed class DisposeRoutine : IDisposable
    {
        ...
        public DisposeRoutine(params IDisposable[] disposables)
        {
             _disposeStack = new Stack<IDisposable>(disposables);
        ...
        /// </returns>
        public DisposeRoutine Append(IDisposable instance)
        {
            this.Test();
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            checkId: "CA2000:Dispose objects before losing scope",
            Justification = "The instance is disposed in a separate routine")]
        public DisposeRoutine Append(Action action)
        {
            this.Test();
